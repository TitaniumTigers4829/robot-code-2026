...
public class TurretConstants {
  ...
  public static double MAX_ANGLE = 4.3;
  public static double MIN_ANGLE = -7.3;
  ...
  public static final double ANGLE_ZERO = 0.306 + .165;
