...
public final class Constants {
  ...
  public static final class FieldConstants {
    ...
    public static final double ALLIANCE_ZONE_DEPTH_METERS = Units.inchesToMeters(ALLIANCE_ZONE_DEPTH_INCHES);
    ...
    public static final double NEUTRAL_ZONE_DEPTH_METERS = Units.inchesToMeters(NEUTRAL_ZONE_DEPTH_INCHES);
    
    // Human starting line (24" from alliance wall)
    public static final double HUMAN_STARTING_LINE_OFFSET_INCHES = 24.0;
    public static final double HUMAN_STARTING_LINE_OFFSET_METERS = Units.inchesToMeters(HUMAN_STARTING_LINE_OFFSET_INCHES);
    ...
    public static final double OUTPOST_AREA_WIDTH_METERS = Units.inchesToMeters(OUTPOST_AREA_WIDTH_INCHES);
    public static final double OUTPOST_AREA_DEPTH_METERS = Units.inchesToMeters(OUTPOST_AREA_DEPTH_INCHES);
    ...
    public static final double HUB_DISTANCE_FROM_WALL_METERS = Units.inchesToMeters(HUB_DISTANCE_FROM_WALL_INCHES);
    ...
    public static final double RED_HUB_X_INCHES = FIELD_LENGTH_INCHES - HUB_DISTANCE_FROM_WALL_INCHES;
    ...
    public static final double HUB_OPENING_SIZE_METERS = Units.inchesToMeters(HUB_OPENING_SIZE_INCHES);
    ...
    public static final double TOWER_LOW_RUNG_HEIGHT_METERS = Units.inchesToMeters(TOWER_LOW_RUNG_HEIGHT_INCHES);
    public static final double TOWER_MID_RUNG_HEIGHT_METERS = Units.inchesToMeters(TOWER_MID_RUNG_HEIGHT_INCHES);
    public static final double TOWER_HIGH_RUNG_HEIGHT_METERS = Units.inchesToMeters(TOWER_HIGH_RUNG_HEIGHT_INCHES);
    
    // TOWER rung extension from upright (5.87" on each side)
    public static final double TOWER_RUNG_EXTENSION_INCHES = 5.875;
    public static final double TOWER_RUNG_EXTENSION_METERS = Units.inchesToMeters(TOWER_RUNG_EXTENSION_INCHES);
    ...
    public static final double TOWER_BASE_WIDTH_METERS = Units.inchesToMeters(TOWER_BASE_WIDTH_INCHES);
    public static final double TOWER_BASE_DEPTH_METERS = Units.inchesToMeters(TOWER_BASE_DEPTH_INCHES);
    public static final double TOWER_BASE_HEIGHT_METERS = Units.inchesToMeters(TOWER_BASE_HEIGHT_INCHES);
    ...
    public static final double BLUE_BUMP_LEFT_X_METERS = Units.inchesToMeters(BLUE_BUMP_LEFT_X_INCHES);
    public static final double BLUE_BUMP_LEFT_Y_METERS = Units.inchesToMeters(BLUE_BUMP_LEFT_Y_INCHES);
    public static final double BLUE_BUMP_RIGHT_X_METERS = Units.inchesToMeters(BLUE_BUMP_RIGHT_X_INCHES);
    public static final double BLUE_BUMP_RIGHT_Y_METERS = Units.inchesToMeters(BLUE_BUMP_RIGHT_Y_INCHES);
    ...
    public static final double RED_BUMP_LEFT_X_METERS = Units.inchesToMeters(RED_BUMP_LEFT_X_INCHES);
    public static final double RED_BUMP_LEFT_Y_METERS = Units.inchesToMeters(RED_BUMP_LEFT_Y_INCHES);
    public static final double RED_BUMP_RIGHT_X_METERS = Units.inchesToMeters(RED_BUMP_RIGHT_X_INCHES);
    public static final double RED_BUMP_RIGHT_Y_METERS = Units.inchesToMeters(RED_BUMP_RIGHT_Y_INCHES);
    ...
    public static final double TRENCH_UNDER_WIDTH_METERS = Units.inchesToMeters(TRENCH_UNDER_WIDTH_INCHES);
    public static final double TRENCH_UNDER_HEIGHT_METERS = Units.inchesToMeters(TRENCH_UNDER_HEIGHT_INCHES);
    ...
    public static final double BLUE_TRENCH_LEFT_Y_INCHES = BLUE_HUB_Y_INCHES - TRENCH_DEPTH_INCHES/2;
    
    public static final double BLUE_TRENCH_RIGHT_X_INCHES = FIELD_LENGTH_INCHES/4;
    public static final double BLUE_TRENCH_RIGHT_Y_INCHES = BLUE_HUB_Y_INCHES - TRENCH_DEPTH_INCHES/2;
    
    public static final double BLUE_TRENCH_LEFT_X_METERS = Units.inchesToMeters(BLUE_TRENCH_LEFT_X_INCHES);
    public static final double BLUE_TRENCH_LEFT_Y_METERS = Units.inchesToMeters(BLUE_TRENCH_LEFT_Y_INCHES);
    public static final double BLUE_TRENCH_RIGHT_X_METERS = Units.inchesToMeters(BLUE_TRENCH_RIGHT_X_INCHES);
    public static final double BLUE_TRENCH_RIGHT_Y_METERS = Units.inchesToMeters(BLUE_TRENCH_RIGHT_Y_INCHES);
    
    // Red alliance TRENCHES
    public static final double RED_TRENCH_LEFT_X_INCHES = FIELD_LENGTH_INCHES * 0.75;
    public static final double RED_TRENCH_LEFT_Y_INCHES = RED_HUB_Y_INCHES - TRENCH_DEPTH_INCHES/2;
    
    public static final double RED_TRENCH_RIGHT_X_INCHES = FIELD_LENGTH_INCHES - TRENCH_WIDTH_INCHES;
    public static final double RED_TRENCH_RIGHT_Y_INCHES = RED_HUB_Y_INCHES - TRENCH_DEPTH_INCHES/2;
    
    public static final double RED_TRENCH_LEFT_X_METERS = Units.inchesToMeters(RED_TRENCH_LEFT_X_INCHES);
    public static final double RED_TRENCH_LEFT_Y_METERS = Units.inchesToMeters(RED_TRENCH_LEFT_Y_INCHES);
    public static final double RED_TRENCH_RIGHT_X_METERS = Units.inchesToMeters(RED_TRENCH_RIGHT_X_INCHES);
    public static final double RED_TRENCH_RIGHT_Y_METERS = Units.inchesToMeters(RED_TRENCH_RIGHT_Y_INCHES);
    ...
    public static final double OUTPOST_CHUTE_OPENING_WIDTH_METERS = Units.inchesToMeters(OUTPOST_CHUTE_OPENING_WIDTH_INCHES);
    public static final double OUTPOST_CHUTE_OPENING_HEIGHT_METERS = Units.inchesToMeters(OUTPOST_CHUTE_OPENING_HEIGHT_INCHES);
    public static final double OUTPOST_CHUTE_OPENING_BOTTOM_METERS = Units.inchesToMeters(OUTPOST_CHUTE_OPENING_BOTTOM_INCHES);
    
    public static final double OUTPOST_CORRAL_WIDTH_METERS = Units.inchesToMeters(OUTPOST_CORRAL_WIDTH_INCHES);
    public static final double OUTPOST_CORRAL_DEPTH_METERS = Units.inchesToMeters(OUTPOST_CORRAL_DEPTH_INCHES);
    public static final double OUTPOST_CORRAL_HEIGHT_METERS = Units.inchesToMeters(OUTPOST_CORRAL_HEIGHT_INCHES);
    
    // Blue OUTPOST (at end of alliance wall)
    public static final double BLUE_OUTPOST_X_INCHES = 0; // At corner of field
    public static final double BLUE_OUTPOST_Y_INCHES = FIELD_WIDTH_INCHES - OUTPOST_CORRAL_DEPTH_INCHES;
    ...
    // Red OUTPOST
    public static final double RED_OUTPOST_X_INCHES = FIELD_LENGTH_INCHES - OUTPOST_CORRAL_WIDTH_INCHES;
    public static final double RED_OUTPOST_Y_INCHES = FIELD_WIDTH_INCHES - OUTPOST_CORRAL_DEPTH_INCHES;
    ...
    public static final double HUB_APRILTAG_HEIGHT_METERS = Units.inchesToMeters(HUB_APRILTAG_HEIGHT_INCHES);
    
    // TOWER WALL AprilTags (IDs 15,16,31,32)
    public static final double TOWER_WALL_APRILTAG_HEIGHT_INCHES = 21.75;
    public static final double TOWER_WALL_APRILTAG_HEIGHT_METERS = Units.inchesToMeters(TOWER_WALL_APRILTAG_HEIGHT_INCHES);
    
    // OUTPOST AprilTags (IDs 13,14,29,30)
    public static final double OUTPOST_APRILTAG_HEIGHT_INCHES = 21.75;
    public static final double OUTPOST_APRILTAG_HEIGHT_METERS = Units.inchesToMeters(OUTPOST_APRILTAG_HEIGHT_INCHES);
    
    // TRENCH AprilTags (IDs 1,6,7,12,17,22,23,28)
    public static final double TRENCH_APRILTAG_HEIGHT_INCHES = 35.0;
    public static final double TRENCH_APRILTAG_HEIGHT_METERS = Units.inchesToMeters(TRENCH_APRILTAG_HEIGHT_INCHES);
    ...
    public static Translation3d getAprilTagPose(int id) {
        switch (id) {
            ...
            case 1: return new Translation3d(BLUE_TRENCH_LEFT_X_METERS, BLUE_TRENCH_LEFT_Y_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            case 6: return new Translation3d(BLUE_TRENCH_RIGHT_X_METERS, BLUE_TRENCH_RIGHT_Y_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            case 7: return new Translation3d(BLUE_TRENCH_RIGHT_X_METERS, BLUE_TRENCH_RIGHT_Y_METERS + TRENCH_WIDTH_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            case 12: return new Translation3d(BLUE_TRENCH_LEFT_X_METERS, BLUE_TRENCH_LEFT_Y_METERS + TRENCH_WIDTH_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            
            case 17: return new Translation3d(RED_TRENCH_LEFT_X_METERS, RED_TRENCH_LEFT_Y_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            case 22: return new Translation3d(RED_TRENCH_RIGHT_X_METERS, RED_TRENCH_RIGHT_Y_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            case 23: return new Translation3d(RED_TRENCH_RIGHT_X_METERS, RED_TRENCH_RIGHT_Y_METERS + TRENCH_WIDTH_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            case 28: return new Translation3d(RED_TRENCH_LEFT_X_METERS, RED_TRENCH_LEFT_Y_METERS + TRENCH_WIDTH_METERS, TRENCH_APRILTAG_HEIGHT_METERS);
            
            // HUB tags (2,3,4,5,8,9,10,11,18,19,20,21,24,25,26,27)
            case 2: return new Translation3d(BLUE_HUB_X_METERS - HUB_WIDTH_METERS/2, BLUE_HUB_Y_METERS - HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 3: return new Translation3d(BLUE_HUB_X_METERS - HUB_WIDTH_METERS/2, BLUE_HUB_Y_METERS + HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 4: return new Translation3d(BLUE_HUB_X_METERS + HUB_WIDTH_METERS/2, BLUE_HUB_Y_METERS + HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 5: return new Translation3d(BLUE_HUB_X_METERS + HUB_WIDTH_METERS/2, BLUE_HUB_Y_METERS - HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            
            case 8: return new Translation3d(BLUE_HUB_X_METERS - HUB_WIDTH_METERS/2, BLUE_HUB_Y_METERS, HUB_APRILTAG_HEIGHT_METERS);
            case 9: return new Translation3d(BLUE_HUB_X_METERS, BLUE_HUB_Y_METERS + HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 10: return new Translation3d(BLUE_HUB_X_METERS + HUB_WIDTH_METERS/2, BLUE_HUB_Y_METERS, HUB_APRILTAG_HEIGHT_METERS);
            case 11: return new Translation3d(BLUE_HUB_X_METERS, BLUE_HUB_Y_METERS - HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            
            case 18: return new Translation3d(RED_HUB_X_METERS - HUB_WIDTH_METERS/2, RED_HUB_Y_METERS - HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 19: return new Translation3d(RED_HUB_X_METERS - HUB_WIDTH_METERS/2, RED_HUB_Y_METERS + HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 20: return new Translation3d(RED_HUB_X_METERS + HUB_WIDTH_METERS/2, RED_HUB_Y_METERS + HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 21: return new Translation3d(RED_HUB_X_METERS + HUB_WIDTH_METERS/2, RED_HUB_Y_METERS - HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            
            case 24: return new Translation3d(RED_HUB_X_METERS - HUB_WIDTH_METERS/2, RED_HUB_Y_METERS, HUB_APRILTAG_HEIGHT_METERS);
            case 25: return new Translation3d(RED_HUB_X_METERS, RED_HUB_Y_METERS + HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            case 26: return new Translation3d(RED_HUB_X_METERS + HUB_WIDTH_METERS/2, RED_HUB_Y_METERS, HUB_APRILTAG_HEIGHT_METERS);
            case 27: return new Translation3d(RED_HUB_X_METERS, RED_HUB_Y_METERS - HUB_DEPTH_METERS/2, HUB_APRILTAG_HEIGHT_METERS);
            
            // OUTPOST tags (13,14,29,30)
            case 13: return new Translation3d(BLUE_OUTPOST_X_METERS + OUTPOST_CORRAL_WIDTH_METERS/2, BLUE_OUTPOST_Y_METERS, OUTPOST_APRILTAG_HEIGHT_METERS);
            case 14: return new Translation3d(BLUE_OUTPOST_X_METERS + OUTPOST_CORRAL_WIDTH_METERS/2, BLUE_OUTPOST_Y_METERS + OUTPOST_CORRAL_DEPTH_METERS/2, OUTPOST_APRILTAG_HEIGHT_METERS);
            case 29: return new Translation3d(RED_OUTPOST_X_METERS + OUTPOST_CORRAL_WIDTH_METERS/2, RED_OUTPOST_Y_METERS, OUTPOST_APRILTAG_HEIGHT_METERS);
            case 30: return new Translation3d(RED_OUTPOST_X_METERS + OUTPOST_CORRAL_WIDTH_METERS/2, RED_OUTPOST_Y_METERS + OUTPOST_CORRAL_DEPTH_METERS/2, OUTPOST_APRILTAG_HEIGHT_METERS);
            
            // TOWER tags (15,16,31,32)
            case 15: return new Translation3d(BLUE_TOWER_X_METERS + TOWER_BASE_DEPTH_METERS/2, BLUE_TOWER_Y_METERS - TOWER_WIDTH_METERS/2, TOWER_WALL_APRILTAG_HEIGHT_METERS);
            case 16: return new Translation3d(BLUE_TOWER_X_METERS + TOWER_BASE_DEPTH_METERS/2, BLUE_TOWER_Y_METERS + TOWER_WIDTH_METERS/2, TOWER_WALL_APRILTAG_HEIGHT_METERS);
            case 31: return new Translation3d(RED_TOWER_X_METERS - TOWER_BASE_DEPTH_METERS/2, RED_TOWER_Y_METERS - TOWER_WIDTH_METERS/2, TOWER_WALL_APRILTAG_HEIGHT_METERS);
            case 32: return new Translation3d(RED_TOWER_X_METERS - TOWER_BASE_DEPTH_METERS/2, RED_TOWER_Y_METERS + TOWER_WIDTH_METERS/2, TOWER_WALL_APRILTAG_HEIGHT_METERS);
            
            default: return new Translation3d(0, 0, 0);
        }
    }
